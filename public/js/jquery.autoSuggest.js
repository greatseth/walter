...
(function($){
	$.fn.autoSuggest = function(data, options) {
	  console.log("autoSuggest entering initialize")
		var defaults = { 
			...
			keyDelay: 400,
		  	start: function() {
		  	  console.log("autoSuggest default start hook")
		  	},
		  	selectionClick: function(elem) {
		  	  console.log("autoSuggest default selectionClick hook")
		  	},
		  	formatList: false, //callback function
		  	retrieveComplete: function(data) {
		  	  console.log("autoSuggest default retrieve complete hook")
		  	  return data;
		  	},
		  	resultsComplete: function(){
		  	  console.log("autoSuggest default results complete hook")
		  	}
	  	};  
	 	var opts = $.extend(defaults, options);	 	
		
		console.log("autoSuggest options", opts)
		...
		if((d_type == "object" && d_count > 0) || d_type == "string"){
		  console.log("autoSuggest dealing with 'object' data")
			...
			return this.each(function(x){
				...
				selections_holder.click(function() {
				  console.log("autoSuggest clicked selections holder")
					input_focus = true;
					input.focus();
				...
				input.focus(function(){			
				  console.log("autoSuggest input focused")
				  ...
				  console.log("autoSuggest input blurred")
					...
					switch(e.keyCode) {
						...
						case 13: // return
							...
							console.log("autoSuggest enter pressed", active, "selected")
					...
					if (string.length >= opts.minChars) {
						...
						if(d_type == "string"){
							...
							$.getJSON(req_string+"?"+opts.queryParam+"="+encodeURIComponent(string)+limit+opts.extraParams, function(data){ 
								...
								console.log("autoSuggest processing string data")
								processData(new_data, string); 
							});
						} else {
						  console.log("autoSuggest processing object data")
				...
				function processData(data, query){
				  console.log("autoSuggest processing data", data, query)
					...
					for(var i=0;i<d_count;i++){				
						...
						if(forward){
						  console.log("autoSuggest forward", this)
							...
							var formatted = $('<li class="as-result-item" id="as-result-item-'+num+'"></li>').click(function(){
									...
									if($("#as-selection-"+num, selections_holder).length <= 0){
										...
										var item = $('<li class="as-selection-item" id="as-selection-'+num+'"></li>').click(function(){
										    console.log("autoSuggest calling opts.selectionClick", opts.selectionClick,
										      "with", this, $(this))
						  ...
						  console.log("autoSuggest not forward", this)
						}
					}
					selections_holder.removeClass("loading");
					if(matchCount <= 0){
		...
		console.log("autoSuggest leaving initialize")
	}
})(jQuery);  	